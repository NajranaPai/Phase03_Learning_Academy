 ...
 */
@WebServlet("/DeleteTeacherSubject")
public class TeacherSubjectDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherSubjectDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TeacherSubject teachersubject=session.load(TeacherSubject.class,tid);
