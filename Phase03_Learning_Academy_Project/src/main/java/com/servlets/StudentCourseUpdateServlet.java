 ...
 */
@WebServlet("/EditStudentAssignment")
public class StudentCourseUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.print("</style></head><body bgcolor=#7575FF><form action=EditStudentAssignment method=post>");
		...
		for(StudentCourse sc:studentcourse)
		{
		 ...
		 {
		  out.print("<tr>");
		  out.print("<td align=center><input class=txt type=text name=\"srno\" style=\"height:30px; width:150px;\" value="+scid+"></td>");
		  out.print("<td align=center width=250px><select class=txt name=\"sname\"style=\"height:30px; width:250px;\">");
		  hql="From Student";
		  ...
		  for(Course c: cname)
		   {
			  if(c.getCourse_Id().equals(sc.getCourse_Id()))
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			for(Course c: course)
			{
			 ...
			 hql="from StudentCourse where Student_Id=:Student_Id and Course_Id=:Course_Id";
			List<StudentCourse> studentcourse=session.createQuery(hql).setParameter("Student_Id",sid).setParameter("Course_Id",cid).list();
