...
public class StudentDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Student student=session.load(Student.class,request.getParameter("sid"));
		session.delete(student);
		
		String hql="Delete From StudentCourse Where Student_Id=:Student_Id";
		Query q=session.createQuery(hql).setParameter("Student_Id", request.getParameter("sid"));
