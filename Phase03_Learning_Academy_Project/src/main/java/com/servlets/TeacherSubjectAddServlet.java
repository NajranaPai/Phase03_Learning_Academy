 ...
 */
@WebServlet("/AssignTeacherSubject")
public class TeacherSubjectAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherSubjectAddServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.print("</style></head><body bgcolor=#7575FF><form action=AssignTeacherSubject method=post>");
		...
		out.print("<tr>");
		out.print("<td align=center><input class=txt type=text name=\"srno\" style=\"height:30px; width:150px;\" value="+(teachersubject.size()+1) +"></td>");
		out.print("<td align=center width=250px><select class=txt name=\"tname\"style=\"height:30px; width:250px;\"><option> Select Teacher </option>");
		hql="From Teacher";
		...
		out.print("</select></td><td align=center width=250px><select class=txt name=\"sname\"style=\"height:30px; width:250px;\"><option> Select Subject </option>");
		hql="From Subject";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cname.equals("Select Course") ||sname.equals("Select Subject") || tname.equals("Select Teacher") )
		{
			hsession.setAttribute("Error", "Please Select Mandatory details");
			response.sendRedirect("AssignTeacherSubject");
		}
		else
		{
			SessionFactory sessionFactory = HibernateUtil.buildSessionFactory();
			...
			hql="From TeacherSubject where Sr_No=:Sr_No Or Teacher_Id=:Teacher_Id and Course_Id=:Course_Id and Subject_Id=:Subject_Id";
			List<TeacherSubject> teachersubject=session.createQuery(hql).setParameter("Sr_No", srno).setParameter("Teacher_Id", tid).setParameter("Course_Id", cid).setParameter("Subject_Id", sid).list();
