...
public class SubjectDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(subject.size()>=1)
		{
			...
			out.print("</table>");
			out.print("<br><a href=AddSubject>Are You want to add subject?</a>");
		...
		else
		{
			...
			out.print("<font style=color:red> No Subject Details Found  </font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
			out.print("<a href=AddSubject>Are You want to add subject?</a></div>");
