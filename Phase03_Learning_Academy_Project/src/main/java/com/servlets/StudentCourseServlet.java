...
public class StudentCourseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(studentcourse.size()>=1)
		{
			...
			out.print("</table>");
			out.print("<br><a href=AddStudentAssignment>Are You want to Assign Course to Student?</a>");
		...
		else
		{
			...
			out.print("<font style=color:red> Nothing Assign to Student</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
			out.print("<a href=AddStudentAssignment>Are You want to Assign Course to Student?</a></div>");
