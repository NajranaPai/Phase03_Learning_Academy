...
public class TeacherDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(teacher.size()>=1)
		{
			...
			out.print("</table>");
			out.print("<br><a href=AddTeacher>Are You want to add Teacher?</a>");
		...
		else
		{
			...
			out.print("<font style=color:red> No Teacher Details Found </font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
			out.print("<a href=AddTeacher>Are You want to add Teacher?</a></div>");
