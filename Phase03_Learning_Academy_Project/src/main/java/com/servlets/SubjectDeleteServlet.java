...
public class SubjectDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Subject subject=session.load(Subject.class,request.getParameter("sid"));
		session.delete(subject);
		
		String hql="Delete from TeacherSubject where Subject_Id=:Subject_Id";
		Query q=session.createQuery(hql).setParameter("Subject_Id",request.getParameter("sid"));
