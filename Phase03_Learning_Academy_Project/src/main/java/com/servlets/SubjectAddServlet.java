...
public class SubjectAddServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.print("</style></head><body bgcolor=#7575FF><form action=AddSubject method=post>");
	   ...
	   // out.print("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp");
		...
		out.print("<tr>");
		String sid;
		if(subject.size()<10) { sid="S0"+(subject.size()+1);} else { sid="S"+(subject.size()+1);}
		out.print("<td align=center width=150px><input class=txt type=text name=\"sid\" style=\"height:30px; width:150px;\" value="+sid +"></td>");
		out.print("<td align=center width=150px><input  class=txt type=text name=\"sname\" style=\"height:30px; width:250px;\"/></td>");
		out.print("<td align=center width=150px><select class=txt name=\"cname\"style=\"height:30px; width:250px;\"><option> Select Course </option>");
		hql="from Course";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			hql="from Subject where (Subject_Id=:Subject_Id OR Subject_Name=:Subject_Name) and Course_Id=:Course_Id";
			List<Subject> subject=session.createQuery(hql).setParameter("Subject_Name", sname).setParameter("Subject_Id", sid).setParameter("Course_Id", cname).list();
			if(subject.size()==0)
			{
